...
function AboutMe() {
  return (
    <section id="about" className="w-full">
      <div className="max-w-7xl mx-auto text-black px-[1.5rem] py-[4rem]">
        <LinkSection label="ABOUT ME" />
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          <IntroduceCard label="이메일" value="yagobo1110@naver.com" Icon={Mail} />
          <IntroduceCard label="학력" value="경민대학교(세무회계과)" Icon={Pencil} />
        </div>
      </div>
    </section>
  );
